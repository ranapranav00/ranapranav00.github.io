        ...
        <div id="home">
            ...
            <div id="bio">
                ...
                <div id="buttons">
                    ...
                    <Button id="button" href="https://drive.google.com/file/d/1rFQZil367mhVwVrWU3_YlBYrKTVdbik3/view?usp=sharing"><AssignmentInd id="r-icon" className="icon"/>Resume</Button>
                </div>
            </div>
        </div>
    )
