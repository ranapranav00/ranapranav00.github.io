...
function Home() {
    return (
        <div id="home">
            <div>
                <img id="profile" src="./images/newpfp.jpg" alt="pfp"/>
            </div>
            <div id="bio">
                ...
                <div id="buttons">
                    ...
                    <Button id="button" href="https://drive.google.com/file/d/1ySLWHvr0aU6L-Gtdd91AUwZ0XUp_b5Uj/view?usp=sharing"><AssignmentInd id="r-icon" className="icon"/>Resume</Button>
                </div>
            </div>
        </div>
    )
